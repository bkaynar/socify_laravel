                        ...
                        <table class="table table-hover">
                            ...
                            <?php $__currentLoopData = $ekipler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ekip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($ekip->id); ?></td>
                                    <td><img src="<?php echo e(asset($ekip->resim)); ?>" alt="Ekip Fotoğrafı" style="min-width: 250px;"></td>
                                    <td><?php echo e($ekip->adsoyad); ?></td>
                                    <td><?php echo e($ekip->unvan); ?></td>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shiningm/ahisocitify.shiningmoony.com.tr/resources/views/pages/ekip/ekip.blade.php ENDPATH**/ ?>